...
public class Admin_Manage_Students extends JDialog implements ActionListener, ComponentListener {
    
    private JButton button_close;
    private JLabel label_idL, label_nameL, label_ic_numberL, label_birth_dateL, label_genderL, label_emailL, label_phone_numberL, label_occupationL, label_blood_typeL,
                    ...
                    label_view_occupation, label_view_blood_type;
    private JPanel panel_main, panel_labels, panel_view;
    private TitledBorder border_view;
    public  int getRegisteredStudentIndex;
    
    public Admin_Manage_Students(){
        ...
        border_view = BorderFactory.createTitledBorder("View Student");
        ...
        gbc.anchor = GridBagConstraints.CENTER;
        gbc.insets = new Insets(0,0,0,0);
        label_occupationL = new JLabel("Occupation:  ");
        label_occupationL.setHorizontalAlignment(SwingConstants.RIGHT);
        label_occupationL.setFont(new Font("Cambria Math",Font.BOLD,20));
        label_occupationL.setForeground(new Color(34,34,59)); 
        panel_labels.add(label_occupationL,gbc);
        ...
        gbc.anchor = GridBagConstraints.CENTER;
        gbc.insets = new Insets(0,0,0,0);
        label_blood_typeL = new JLabel("Blood Type:  ");
        label_blood_typeL.setHorizontalAlignment(SwingConstants.RIGHT);
        label_blood_typeL.setFont(new Font("Cambria Math",Font.BOLD,20));
        label_blood_typeL.setForeground(new Color(34,34,59)); 
        panel_labels.add(label_blood_typeL,gbc);
        ...
        gbc.anchor = GridBagConstraints.CENTER;
        gbc.insets = new Insets(0,0,0,0);
        label_view_occupation = new JLabel("Student");
        label_view_occupation.setHorizontalAlignment(SwingConstants.LEFT);
        label_view_occupation.setFont(new Font("Cambria Math",Font.PLAIN,20));
        label_view_occupation.setForeground(new Color(34,34,59)); 
        panel_view.add(label_view_occupation,gbc);
        ...
        gbc.anchor = GridBagConstraints.CENTER;
        gbc.insets = new Insets(0,0,0,0);
        label_view_blood_type = new JLabel("00-00-0000");
        label_view_blood_type.setHorizontalAlignment(SwingConstants.LEFT);
        label_view_blood_type.setFont(new Font("Cambria Math",Font.PLAIN,20));
        label_view_blood_type.setForeground(new Color(34,34,59)); 
        panel_view.add(label_view_blood_type,gbc);
    ...
    public void componentShown(ComponentEvent e) {
        //change the text of all labels according to selected students when the frame is shown
        label_view_id.setText(OODJ_Assignment.allStudent.get(getRegisteredStudentIndex).getID());
        label_view_name.setText(OODJ_Assignment.allStudent.get(getRegisteredStudentIndex).getName());
        label_view_ic_number.setText(OODJ_Assignment.allStudent.get(getRegisteredStudentIndex).getIC());
        label_view_birth_date.setText(OODJ_Assignment.allStudent.get(getRegisteredStudentIndex).getDOB());
        label_view_gender.setText(OODJ_Assignment.allStudent.get(getRegisteredStudentIndex).getGender());
        label_view_email.setText(OODJ_Assignment.allStudent.get(getRegisteredStudentIndex).getEmail());
        label_view_phone_number.setText(OODJ_Assignment.allStudent.get(getRegisteredStudentIndex).getPhone_number());
        label_view_occupation.setText(OODJ_Assignment.allStudent.get(getRegisteredStudentIndex).getOccupation());
        label_view_blood_type.setText(OODJ_Assignment.allStudent.get(getRegisteredStudentIndex).getBlood_type());
    }
